...
class Settings(BaseSettings):
    ...
    llm_base_url: str = Field(
        default="https://imllm.intermesh.net/v1", env="LLM_BASE_URL"
    )
    ...
    demo_space_id: str = Field(default="", env="DEMO_SPACE_ID")
    ...
    # ── Security ──
    webhook_audience: str = Field(
        default="",
        env="WEBHOOK_AUDIENCE",
        description="Expected JWT audience for Google Chat webhook verification. "
        "Set to your Cloud Run URL. Leave empty to disable (dev mode).",
    )
    internal_api_token: str = Field(
        default="",
        env="INTERNAL_API_TOKEN",
        description="Bearer token required to access /logs and /health/details. "
        "Leave empty to disable protection (dev mode).",
    )
    db_encryption_key: str = Field(
        default="",
        env="DB_ENCRYPTION_KEY",
        description="Fernet key (or passphrase) used to encrypt OpenProject API keys at rest. "
...
OP_BUCKET_CATEGORIES = {
    ...
    "Android": {
        ...
        "Deeplinking": 655,
        "BuyLeads": 651,
        "Buyer Message Centre": 649,
        "App Communications": 639,
        "App config": 640,
        "BizFeed": 644,
        "Sell on Indiamart": 686,
        "User Onboarding": 691,
        "XMPP": 692,
        "Search_webview": 1817,
        "PDP_webview": 1818,
        "Products_Webview": 1999,
        "BMC_WEBVIEW": 1410,
        "LMS_Webview": 1811,
        "BL_Webview": 1810,
        "Webview-Buyer": 2106,
    ...
    "iOS": {
        ...
        "Guest User": 2115,
        "Lead Manager": 529,
        "Login & On Boarding": 2116,
        "My Products": 539,
        "My Profile": 540,
        "Notifications": 541,
        "PBR": 544,
        "Seller dashboard": 553,
        "Sell on Indiamart": 554,
        "Web View BMC": 1423,
        "Webview Buyer": 2108,
        "Webview Buylead": 2114,
        "Webview Export": 2110,
        "Webview Lens": 2109,
        "Webview LMS": 2113,
        "Webview Settings": 2117,
        "Who Viewed My Catalog": 557,
    },
    ...
    "Msite": {
        ...
        "Enquiry": 602,
        "All M-Site": 598,
        "Ratings & Reviews": 1466,
        "Webview": 1462,
        "Whatsapp": 1627,
        "PDP Webview": 2124,
        "Company Webview": 2128,
        "Forms Webview": 2129,
    },
    ...
    "Desktop PDP": {
        "PDP Tasks Desktop": 1159,
        "Conversion": 1026,
        "Rating and Review": 1684,
        "SEO": 1025,
        "Technical": 1683,
    },
    # ── Desktop Login categories ──
    "Desktop Login": {
        "User Login/Auto Login": 1578,
        "Verification": 1579,
        "Identification": 374,
    },
    ...
    "Desktop Homepage": {
        "Buyer Dashboard": 283,
        "Supplier Dashboard": 289,
        "Categories & User Personalization Sections(identified)": 284,
        "DIR - Home & Static Pages": 286,
        "Others": 288,
    },
    # ── Seller Dashboard categories ──
    "Seller Dashboard": {
        "Seller Dashboard": 1498,
        "Seller Products": 410,
        "Seller Profile": 1499,
        "Seller Settings": 1503,
        "Seller Buyer Tools": 1502,
        "Seller Login": 1510,
        "Seller Photos & Docs": 411,
        "Seller Invoices": 1501,
        "Online Sales": 1509,
    },
    ...
    "Buyer MY.IM": {
        "Buyer MY": 1615,
        "Business Requirement": 1807,
        "Adhoc Requirement": 1471,
        "Ratings & Reviews": 1663,
        "User Login/Auto Login": 1472,
        "Settings/Change Password": 408,
    },
}
